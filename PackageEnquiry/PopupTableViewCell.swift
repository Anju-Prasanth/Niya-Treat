...
class PopupTableViewCell: UITableViewCell {
    ...
    @IBOutlet weak var txtfldpackage: DropDown!
    ...
    override func awakeFromNib() {
        super.awakeFromNib()
       txtfldpackage.layer.cornerRadius=5
        txtfldpackage.layer.borderWidth=1
        txtfldpackage.layer.borderColor = UIColor.lightGray.cgColor
